...
<img style="float: right;" id="fondo" src="PhotoBase/Mark/clase1.jpg"/>
</div>
</div>
<br/>
   <p id="texto">
  ...
  <div class="row" id="showing">
    ...
    ?>
		    ...
		    <center>
		<p style="font: bold 40% monospace; font-size: 40px; margin: auto; margin-top: 100px;">
		   colecciones en proceso y fabricación
		</p>
		</center>

  <br/><br/>
  <center><a href="Index.php?action=CheckoutCompra" id="btn" class="btn btn-primary">Continuar&nbsp;<i class="fa fa-solid fa-cart-plus"></i></a></center>
 </div>
</br></br></br>
</body>
<footer>
